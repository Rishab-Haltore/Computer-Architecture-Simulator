...
//        System.out.println(Utils.generate_opcode("LDR R0, X1, 45[,I]") + "\n");
//        System.out.println(Utils.generate_opcode("STR R3, X3, 45") + "\n");
//
//
//        System.out.println("I -> " + "0" + "\t" + "X -> " + "No X" + "\t" +
//                "Address -> " + String.format("%6s", Integer.toBinaryString(50)).replace(' ', '0'));
//        System.out.println(Utils.calculate_effective_address("0", "00",
//                String.format("%6s", Integer.toBinaryString(50)).replace(' ', '0')) + "\n");
//
//
//
...
//
//        // Testing LDR
//        Memory.store_to_memory(50, 20);
//        Memory.store_to_memory(75, 63);
//
//        Registers.update_registers("X1", 25);
//
//        System.out.println("LDR R0, X0, 50");
//        Utils.execute(Utils.generate_opcode("LDR R0, X0, 50"));
//        System.out.println(Registers.get_register_value_int("R0") + "\n");
//
//
//        System.out.println("LDR R0, X1, 50");
//        Utils.execute(Utils.generate_opcode("LDR R0, X1, 50"));
//        System.out.println(Registers.get_register_value_int("R0" ) + "\n");
//
//        Memory.reset_memory();
//        Memory.store_to_memory(50, 75);
...
//        Utils.execute(Utils.generate_opcode("LDR R0, X0, 50[,I]"));
//        System.out.println(Registers.get_register_value_int("R0") + "\n");
//
//        System.out.println("LDR R0, X1, 100[,I]");
//        Utils.execute(Utils.generate_opcode("LDR R0, X1, 100[,I]"));
//        System.out.println(Registers.get_register_value_int("R0") + "\n");
//
//
//
...
//
//        System.out.println("STR R1, X0, 95");
//        Utils.execute(Utils.generate_opcode("STR R1, X0, 95"));
